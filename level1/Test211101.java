...
ex) 이용금액이 3인 놀이기구를 4번 타고 싶은 고객이 현재 가진 금액이 20이라면,
총 필요한 놀이기구의 이용 금액은 30 (= 3+6+9+12) 이 되어 10만큼 부족하므로 10을 return 합니다.*/

package level_1;

public class Test211101 {
	...
	public static void main(String[] args) {
		    ...
		    System.out.println( money-temp > 0 ? 0 : temp-money );
			/*
			  if(temp<money) System.out.println("0"); 
			  else System.out.println(temp-money);
			 */
	}		
}
